<?php
    include_once __DIR__ . '/workshops-conferencia.php';
?>
        ...
        <?php foreach($ponentes as $ponente) { ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen-autor" loading="lazy" width="200" height="300" src="img/speakers/<?php echo $ponente->imagen; ?>" alt="Imagen ponente">
                </picture>
